...
<head>
  ...
  <meta name="description"
    content="株式会社ミライト・ワン・システムズのウェブサイトです。Value Engine for your future.急速に変化する市場環境に適合し、豊かな未来への社会基盤の創造に向けて、私たちの終わらない挑戦がいま、始まります。">
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/css/modaal.css">
  <link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/css/common.css">
  <link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/css/mis.css">
...
<script>
  ...
  <title>トップページ - 株式会社ミライト・ワン・システムズ</title>
          ...
          <div class="p-section">
            <div class="p-section__inner">
              <div class="p-header__logo">
                <p>
                  <a href="/index.html">
                    <i><img src="https://placehold.co/243x38" alt="MIRAIT ONE GROUP" decoding="async"
                        loading="lazy"></i>
                  </a>
                </p>
              </div>
                  ...
                  <ul>
                    ...
                    <li data-gnavi="solution">
                      <dl>
                        ...
                        <dd>
                          <ul>
                            <li><a href="/solution.html#lnk-system"><strong>システム開発・運用</strong></a></li>
                            <li><a href="/solution.html#lnk-cloud"><strong>クラウド構築・運用</strong></a></li>
                            <li><a href="/solution.html#lnk-smartdevice"><strong>スマートデバイスソリューション</strong></a></li>
                            <li><a href="/solution.html#lnk-rpa"><strong>RPAソリューション</strong></a></li>
                          </ul>
                        </dd>
                      </dl>
                    </li>
