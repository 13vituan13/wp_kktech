                ...
                <div class="p-section__inner">
                  ...
                  <div class="p-newstop__box">
                    <ul>
                      ...
                      <li data-cate="お知らせ">
                        <a href="https://www.mirait-one-systems.co.jp/2024/10/post-10.html">
                          <div class="p-newstop__box_item">
                            <div class="p-newstop__box_item--date">
                              <p><strong>2024.10.11</strong></p>
                            </div>
                            <div class="p-newstop__box_item--txt">
                              <p class="news_list_title">「次世代育成支援対策推進法」に基づく厚生労働省の「くるみん認定」を取得しました</p>
                            </div>
                          </div>
                        </a>
                      </li>
                      ...
                      <li data-cate="イベント">
                        <a href="https://www.mirait-one-systems.co.jp/2024/09/crm-2024in-25casting-table40.html">
                          <div class="p-newstop__box_item">
                            <div class="p-newstop__box_item--date">
                              <p><strong>2024.09.19</strong></p>
                            </div>
                            <div class="p-newstop__box_item--txt">
                              <p class="news_list_title">コールセンター/CRM デモ&コンファレンス2024 in 東京（第25回）に「Casting
                                Table4.0」と「コンレポシリーズ」を出展</p>
                            </div>
                          </div>
                        </a>
                      </li>
                      ...
                      <li data-cate="イベント">
                        <a href="https://www.mirait-one-systems.co.jp/2024/08/ceatec-2024for-education.html">
                          <div class="p-newstop__box_item">
                            <div class="p-newstop__box_item--date">
                              <p><strong>2024.08.27</strong></p>
                            </div>
                            <div class="p-newstop__box_item--txt">
                              <p class="news_list_title">「CEATEC2024」に「コンレポシリーズ/コンレポfor Education」および「みらいコネクト」を出展</p>
                            </div>
                          </div>
                        </a>
                      </li>
                      ...
                      <li data-cate="イベント">
                        <a href="https://www.mirait-one-systems.co.jp/2024/07/27castingtable40.html">
                          <div class="p-newstop__box_item">
                            <div class="p-newstop__box_item--date">
                              <p><strong>2024.07.25</strong></p>
                            </div>
                            <div class="p-newstop__box_item--txt">
                              <p class="news_list_title">「第27回カスタマーサポートシンポジウム」にて、「Casting Table4.0」の講演を行います</p>
                            </div>
                          </div>
                        </a>
                      </li>
                      ...
                      <li data-cate="お知らせ">
                        <a href="https://www.mirait-one-systems.co.jp/2024/06/post-9.html">
                          <div class="p-newstop__box_item">
                            <div class="p-newstop__box_item--date">
                              <p><strong>2024.06.17</strong></p>
                            </div>
                            <div class="p-newstop__box_item--txt">
                              <p class="news_list_title">役員の異動に関するお知らせ</p>
                            </div>
                          </div>
                        </a>
                      </li>
                  ...
                  <div class="p-newstop__btn">
                    <div class="p-stdbtn p-stdbtn__clr p-stdbtn__clr_maintheme">
                      <div class="p-stdbtn__btn">
                        <ul>
                          <li><a href="/newslist.html"><strong>一覧をみる</strong></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
