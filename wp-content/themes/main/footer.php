                    ...
                    <dl>
                      ...
                      <dd>
                        <ul>
                          ...
                          <li><a href="/solution/magicconnect.html" target="_blank"><strong>MagicConnect</strong></a>
                          </li>
                          <li><a href="/solution/amivoice.html" target="_blank"><strong>AmiVoice Keyboard</strong></a>
                          </li>
                      ...
                      <dd>
                        <ul>
                          <li><a href="/ibm/softlayer/index.html"><strong>MIRACLE<br
                                  class="sw_pc"><small>（クラウド総合支援サービス）</small></strong></a></li>
                        </ul>
                      </dd>
                    </dl>
                  </div>
            ...
            <div class="p-section__inner">
              <div class="p-footer__guidance">
                ...
                <div class="p-footer__credential">
                  <ul>
                    <li><i><img src="https://placehold.co/126x105" alt="JUSE" decoding="async" loading="lazy"></i></li>
                    <li><i><img src="https://placehold.co/92x105" alt="プライバシーマーク" decoding="async" loading="lazy"></i>
                    </li>
              ...
              <div class="p-footer__copyright">
                <ul>
                  <li>※ IBM Cloud®は世界の多くの国で登録されたInternational Business Machines Corporationの商標です。<br>※
                    楽々Framework、楽々Workflowは住友電気工業の登録商標です。<br>※ WinActor®はNTTアドバンステクノロジ株式会社の登録商標です。<br>※「MagicConnect
